...
class Statistics {
	...
	public static $lists = [
		...
		'Best "the 2nd place collection" of all events'=>[
			'class'=>'PosCollection',
			'type'=>'all',
			'pos'=>2,
			'round'=>['c', 'f'],
		...
		'Best "the 2nd place collection" in each events'=>[
			'class'=>'PosCollection',
			'type'=>'each',
			'pos'=>2,
			'round'=>['c', 'f'],
		...
		'Best "the 4th place collection" of all events'=>[
			'class'=>'PosCollection',
			'type'=>'all',
			'pos'=>4,
			'round'=>['c', 'f'],
		...
		'Best "the 4th place collection" in each events'=>[
			'class'=>'PosCollection',
			'type'=>'each',
			'pos'=>4,
			'round'=>['c', 'f'],
